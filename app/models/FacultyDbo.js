...
module.exports = class FacultyDbo {
    ...
    static fetchAll(rowcount) {
        return poolConnection.then(pool => {
            return pool.request().query(`SELECT TOP ${Number(rowcount)} fs.id, fs.faculty_id, fs.faculty_name,camp.campus_abbr, org.org_abbr, sit.start_time, sit.end_time, fs.is_processed FROM [dbo].faculties fs
